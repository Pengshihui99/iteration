...
goal is to write a function that simulates data and then fits a reg; then repeat to look at the distribution of estimated coefficients.
```{r}
beta_0 = 2
beta_1 = 3
...
for this case, we can use `map2()` which allows mapping over two inputs to a function. 
* `map2()` is used for iterating over two vectors or lists element-wise. 
  * map2(vec1. vec2, function(x){...})